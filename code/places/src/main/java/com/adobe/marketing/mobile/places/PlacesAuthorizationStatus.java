...
public enum PlacesAuthorizationStatus {
    ...
    /**
     * UNKNOWN - The location authorization status is unknown. This is the default authorization
     * status.
     */
    UNKNOWN("unknown"),
     ...
     *
     * <p>Returns null if the provided string is not a valid {@link PlacesAuthorizationStatus} enum
     * value
     *
