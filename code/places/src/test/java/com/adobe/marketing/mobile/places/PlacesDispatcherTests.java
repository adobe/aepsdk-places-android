...
public class PlacesDispatcherTests {
    ...
    private static Map<String, String> SAMPLE_METADATA =
    ...
    private static Event triggerEvent =
            new Event.Builder("Test event", EventType.PLACES, EventSource.REQUEST_CONTENT)
                    .setEventData(null)
                    .build();
    ...
    public void test_dispatchNearbyPlaces() {
        ...
        assertEquals(
                PlacesTestConstants.EventName.RESPONSE_GETNEARBYPLACES, dispatchedEvent.getName());
        assertEquals(EventType.PLACES, dispatchedEvent.getType());
        assertEquals(EventSource.RESPONSE_CONTENT, dispatchedEvent.getSource());
        assertTrue(
                dispatchedEvent
                        .getEventData()
                        .containsKey(PlacesTestConstants.EventDataKeys.Places.NEAR_BY_PLACES_LIST));
        assertEquals(
                PlacesRequestError.OK.getValue(),
                (int)
                        dispatchedEvent
                                .getEventData()
                                .get(PlacesTestConstants.EventDataKeys.Places.RESULT_STATUS));
    ...
    public void test_dispatchUserWithinPOIs() {
        ...
        // verify dispatchedEvent
        assertEquals(
                PlacesTestConstants.EventName.RESPONSE_GETUSERWITHINPLACES,
                dispatchedEvent.getName());
        assertEquals(EventType.PLACES, dispatchedEvent.getType());
        assertEquals(EventSource.RESPONSE_CONTENT, dispatchedEvent.getSource());
        Map<String, Object> eventData = dispatchedEvent.getEventData();
        assertTrue(
                eventData.containsKey(PlacesTestConstants.EventDataKeys.Places.USER_WITHIN_POIS));
    ...
    public void test_dispatchRegionEvent() {
        ...
        final PlacesPOI poi =
                new PlacesPOI(
                        ...
                        SAMPLE_WEIGHT,
                        SAMPLE_METADATA);
        final PlacesRegion region =
                new PlacesRegion(poi, PlacesRegion.PLACE_EVENT_ENTRY, 777777777);
        ...
        assertEquals(
                PlacesTestConstants.EventName.RESPONSE_PROCESSREGIONEVENT,
                dispatchedEvent.getName());
        assertEquals(EventType.PLACES, dispatchedEvent.getType());
        assertEquals(EventSource.RESPONSE_CONTENT, dispatchedEvent.getSource());
        ...
        assertEquals(
                dispatchedEvent
                        .getEventData()
                        .get(PlacesTestConstants.EventDataKeys.Places.REGION_TIMESTAMP),
    ...
    public void test_dispatchLastKnownLocation() {
        ...
        // verify event details
        assertEquals(
                PlacesTestConstants.EventName.RESPONSE_GETLASTKNOWNLOCATION,
                dispatchedEvent.getName());
        assertEquals(EventType.PLACES, dispatchedEvent.getType());
        assertEquals(EventSource.RESPONSE_CONTENT, dispatchedEvent.getSource());
        assertEquals(2, dispatchedEvent.getEventData().size());
        ...
        assertEquals(
                ...
                (double)
                        dispatchedEvent
                                .getEventData()
                                .get(PlacesTestConstants.EventDataKeys.Places.LAST_KNOWN_LATITUDE),
                0);
        assertEquals(
                -121.33,
                (double)
                        dispatchedEvent
                                .getEventData()
                                .get(PlacesTestConstants.EventDataKeys.Places.LAST_KNOWN_LONGITUDE),
                0);
        assertEquals(triggeringEvent.getUniqueIdentifier(), dispatchedEvent.getResponseID());
    }
    ...
    public void test_sendExperienceEventToEdge_WithValidEntryEvent() {
        ...
        final Map<String, Object> xdm =
                (Map<String, Object>)
                        dispatchedEvent.getEventData().get(PlacesTestConstants.XDM.Key.XDM);
        assertEquals(
                PlacesTestConstants.XDM.Location.EventType.ENTRY,
                xdm.get(PlacesTestConstants.XDM.Key.EVENT_TYPE));

        final Map<String, Object> placesContext =
                (Map<String, Object>) xdm.get(PlacesTestConstants.XDM.Key.PLACE_CONTEXT);
        final Map<String, Object> poiInteraction =
                (Map<String, Object>)
                        placesContext.get(PlacesTestConstants.XDM.Key.POI_INTERACTION);

        final Map<String, Object> poiDetail =
                (Map<String, Object>) poiInteraction.get(PlacesTestConstants.XDM.Key.POI_DETAIL);
        ...
        final List<Map<String, Object>> metadataList =
        ...
        assertEquals(
                "xdm.placeContext.POIinteraction.poiDetail.poiID", dispatchedEvent.getMask()[1]);
    }
